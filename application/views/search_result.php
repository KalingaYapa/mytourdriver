                                ...
                                <div class="searh-row clearfix" style="">
                                    ...
                                    <div class="col-sm-2">
                                        <div >
                                            ...
                                            <a class="btn btn-lg btn-success pull-right" href="extras.php" style="border-radius: 4px" onclick="submitBookingForm('SD', '4500', '4500', 'Perodua Axia - Green', '45', '100', '125')">Book Now</a>
                                        </div>
                                    </div>
