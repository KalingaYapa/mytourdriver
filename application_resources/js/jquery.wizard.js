	...
	methods = {
		init: function (element, options) {
			...
			if(opts.bottomButtons && !bottomActions.length){
				...
				html += '<span class="btn btn-default btn-prev"><span class="previous-text">'+ opts.text.previous +'</span></span>';
				html += '<span class="btn btn-default btn-next"><span class="next-text">'+ opts.text.next +'</span><span class="finished-text">'+ opts.text.finished +'</span></span>';
				html += '</div>';
